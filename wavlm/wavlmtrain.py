...
def resample_feature(file_path, target_length=200):
    try:
        mat = scipy.io.loadmat(file_path)
        wavlm_feature = mat['features']
...
wavlm_features = []
for path in tqdm(df['path_wavlm'], desc='Processing wavlm features'):
...
plt.savefig('/home/xrl/speech/wavlm/wavlmmatrix/matrix_savee.png')
plt.show()
# Print metrics
